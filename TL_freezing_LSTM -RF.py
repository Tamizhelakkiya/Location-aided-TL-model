...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec 19 01:32:26 2022
...
model = load_model('/media/tamizh/Backup Plus/CRL/CRL/DL_model_papersubmission_2.3.2021/models/highSNR_Model_lstm_64')
model.summary()

for layer in model.layers:
	layer.trainable = False

new_model = Model(inputs=model.input, outputs=model.get_layer('lstm_1').output)
new_model.summary()
##RANDOM FOREST
...
pickle.dump(TL_model, open('model_LSTM_TL_RF.sav', 'wb'))

print('LSTM_RF_with_freezing model generated')
t2=time.time()
...
#    print(df_confusion)
    ...
    plt3.tight_layout()
#    plt3.show()
    plt3.savefig('/home/tamizh/Documents/CNN_Ieee_access/confusion_matrix_lstm_rf/'+plot_extn+'ConfusionMatrix_lstm_TL.png',dpi=200)
    plt3.close()
    plt3.clf()
